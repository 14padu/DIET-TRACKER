...
const QRCodePage = () => {
  ...
  const baseUrl = `https://3000-14padu-diettracker-l9ialcss88u.ws-us117.gitpod.io/api/person`;

  // Fetch diet data when the component loads
  useEffect(() => {
    axios
      .get(`https://3000-14padu-diettracker-l9ialcss88u.ws-us117.gitpod.io/api/person`) // API endpoint to fetch clinic data
      .then(res => {
