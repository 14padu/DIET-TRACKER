...
const ShowPersonDetails = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://3000-14padu-diettracker-chv0inba8k3.ws-us117.gitpod.io/api/Person/${id}`)
  ...
  const handleDelete = () => {
    axios
      .delete(`https://3000-14padu-diettracker-chv0inba8k3.ws-us117.gitpod.io/api/Person`)
      .then(() => {
