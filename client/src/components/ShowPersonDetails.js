...
const ShowPersonDetails = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://3000-14padu-diettracker-o5gsxf21sio.ws-us117.gitpod.io/api/Person/${id}`)
  ...
  const handleDelete = () => {
    axios
      .delete(`https://3000-14padu-diettracker-o5gsxf21sio.ws-us117.gitpod.io/api/Person/${id}`)
      .then(() => {
